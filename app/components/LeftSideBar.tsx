...
const LeftSidebar = ({ allShapes }: { allShapes: Array<any> }) => {
  ...
  const memoizedShapes = useMemo(
    () => (
      <section className="flex flex-col border-t border-primary-grey-200 bg-primary-black text-primary-grey-300 min-w-56.75 sticky left-0 h-full max-sm:hidden select-none overflow-y-auto pb-20">
