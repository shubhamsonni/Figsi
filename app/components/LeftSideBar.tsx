...
const LeftSidebar = ({ allShapes }: { allShapes: Array<any> }) => {
  ...
  const memoizedShapes = useMemo(
    () => (
      <section className="flex flex-col border-t border-gray-200 bg-black text-gray-300 min-w-56.75 sticky left-0 h-full max-sm:hidden select-none overflow-y-auto pb-20">
          ...
          {allShapes?.map((shape: any) => {
            ...
            return (
              <div
                ...
                className="group my-1 flex items-center gap-2 px-5 py-2.5 hover:cursor-pointer hover:bg-green-600 hover:text-black"
              >
                <Image
                  src={info?.icon}
                  alt='Layer'
